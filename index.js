...
//     } else {
//         const newPrice = customerCredits - totalPrice;
//         console.log(newPrice);
//         message = `You ordered ${orderedQuantity} droids, you have ${newPrice} credits left`;
//     }
...
//         result = message;
//     } else {
//         let newFormat = message.slice(0, maxLength);
//         // let newFormaend = newFormat.endsWith('...');
